...
export default async function ReportesPage({
  ...
  const resumen = await resumenLlamadasPorAbogado(mes, ANIO_PROSPECTOS);
  ...
  return <ReportesClient resumen={resumen} hoyLabel={hoyLabel} filtroMes={mes} esMesActual={mes === mesActual} />;
}
